...
<?php if (!$laporan_bulan_ini): ?>
    <div style="background: rgba(255, 76, 76, 0.1); border: 1px solid #ff4c4c; padding: 15px; border-radius: 10px; margin-bottom: 30px; display: flex; align-items: center; gap: 15px;">
        ...
        <div>
            ...
            <span style="font-size: 13px; color: rgba(255,255,255,0.8);">Seksi <?= $nama_seksi ?> <strong>belum mengunggah</strong> laporan untuk periode <?= $list_bulan[$bulan_sekarang] ?> <?= $tahun_sekarang ?>.</span>
        </div>
    </div>
<?php else: ?>
    <div style="background: rgba(100, 255, 218, 0.1); border: 1px solid #64ffda; padding: 15px; border-radius: 10px; margin-bottom: 30px; display: flex; align-items: center; gap: 15px;">
        ...
        <div>
            ...
            <span style="font-size: 13px; color: rgba(255,255,255,0.8);">Laporan periode <?= $list_bulan[$bulan_sekarang] ?> <?= $tahun_sekarang ?> sudah diunggah. Tetap pertahankan kedisiplinannya, cuy!</span>
        </div>
    </div>
<?php endif; ?>
...
<div class="glass panel-utama" style="padding: 30px;">
    <div class="panel-tabel">
        <div style="margin-bottom: 15px; display: flex; justify-content: space-between; align-items: center;">
            <h4 style="margin: 0; color: var(--text-white);">Riwayat Laporan</h4>
