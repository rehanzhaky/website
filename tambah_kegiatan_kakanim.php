...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['dokumentasi_png']) && $_FILES['dokumentasi_png']['error'] != UPLOAD_ERR_NO_FILE) {
        ...
        if ($file_ext == 'png') {
            $nama_file_png = time() . "_kegiatan_" . uniqid() . ".png";
    ...
    if (isset($_FILES['dokumentasi_pdf']) && $_FILES['dokumentasi_pdf']['error'] != UPLOAD_ERR_NO_FILE) {
        ...
        if ($file_ext == 'pdf') {
            $nama_file_pdf = time() . "_kegiatan_" . uniqid() . ".pdf";
            $folder_tujuan = "uploads/agenda/";
    ...
    if (!isset($error)) {
        ...
        if ($stmt->execute([$nama_kegiatan, $lokasi, $tanggal, $keterangan, $nama_file_png, $nama_file_pdf, 'kegiatan_kakanim'])) {
...
<div class="dashboard-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    <div>
        <h2>📅 Tambah Kegiatan Kakanim</h2>
        <p>Catat kegiatan Kepala Kantor Imigrasi dengan dokumentasi PNG & PDF.</p>
    </div>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            <div class="form-group form-full">
                ...
                <input type="text" name="nama_kegiatan" placeholder="Contoh: Kunjungan Kerja Kakanim ke Bintan" required autocomplete="off">
            </div>
            
            <div class="form-group">
                <label>Lokasi</label>
                <input type="text" name="lokasi" placeholder="Contoh: Kantor Bupati Bintan" required autocomplete="off">
            </div>
            ...
            <div class="form-group form-full">
                ...
                <textarea name="keterangan" rows="3" placeholder="Deskripsi singkat kegiatan..."></textarea>
            </div>
