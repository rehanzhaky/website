...
<div class="accordion-item">
    <div class="accordion-header" onclick="toggleAccordion(this)">
        <span style="display: flex; align-items: center; gap: 10px;">
            <span style="font-size: 20px;">🏢</span> Seksi <?= htmlspecialchars($seksi) ?>
        </span>
    ...
    <div class="accordion-body">
        <div class="accordion-content">
            <a href="daftar_laporan_umum.php?seksi=<?= $slug_seksi ?>" class="action-card view">
                ...
                <div class="card-desc">
                    Buka dan pantau rekam jejak dokumen laporan yang sudah diarsipkan oleh Seksi <?= htmlspecialchars($seksi) ?>. Anda dapat mengunduh atau mencetak dokumen dari menu ini.
                </div>
            </a>
            ...
            <a href="upload_laporan_umum.php?seksi=<?= $slug_seksi ?>" class="action-card upload">
                ...
                <div class="card-desc">
                    Unggah file dokumen laporan terbaru untuk Seksi <?= htmlspecialchars($seksi) ?> ke dalam sistem arsip. Pastikan file berformat PDF atau Excel yang telah disetujui.
                </div>
            </a>
        </div>
    </div>
